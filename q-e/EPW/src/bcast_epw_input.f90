  ...
  USE epwcom,        ONLY : tdboltzmann, tstep, ntstep, tstep_write, temp_el, &
                            temp_ph, initial_type, initial_sigma, ef_c, ef_v, &
                            carrier_dynamic, double_grid, nkf1d, nkf2d, nkf3d,&
                            nqf1d, nqf2d, nqf3d, dph, bte_restart, bte_phph,  &
                            bte_elel, bte_solver, ph_read, ph_rta, facbroad,  &
                            phwmin, teph_max, ephmat_dir, lscreen_tdbe,       &
                            static_scr, mode_select, phself_anh, two_ef,      &
                            phlw_chp, lorentz_gamma, phphself_r                              
  ! -------------------------------------------------------------------------------------
  USE elph2,         ONLY : elph
  ...
  !
  ! ---------------------------------------------------------------------------------
  ! Added by Yiming Pan for tdbe calculations
  CALL mp_bcast (tdboltzmann   , meta_ionode_id, world_comm)
  CALL mp_bcast (tstep_write   , meta_ionode_id, world_comm)
  CALL mp_bcast (tstep         , meta_ionode_id, world_comm)
  CALL mp_bcast (ntstep   , meta_ionode_id, world_comm)
  CALL mp_bcast (temp_el   , meta_ionode_id, world_comm)
  CALL mp_bcast (temp_ph   , meta_ionode_id, world_comm)
  CALL mp_bcast(initial_sigma, meta_ionode_id, world_comm)
  CALL mp_bcast(initial_type, meta_ionode_id, world_comm)
  CALL mp_bcast(ef_v, meta_ionode_id, world_comm)
  CALL mp_bcast(ef_c, meta_ionode_id, world_comm)
  CALL mp_bcast(carrier_dynamic, meta_ionode_id, world_comm)
  ...
  CALL mp_bcast (dph, meta_ionode_id, world_comm)
  CALL mp_bcast (bte_restart, meta_ionode_id, world_comm)
  CALL mp_bcast (bte_solver, meta_ionode_id, world_comm)
  CALL mp_bcast (bte_phph, meta_ionode_id, world_comm)
  CALL mp_bcast (bte_elel, meta_ionode_id, world_comm)
  CALL mp_bcast (ph_read, meta_ionode_id, world_comm)
  CALL mp_bcast (ph_rta, meta_ionode_id, world_comm)
  CALL mp_bcast (facbroad, meta_ionode_id, world_comm)
  CALL mp_bcast (phwmin, meta_ionode_id, world_comm)
  CALL mp_bcast (teph_max, meta_ionode_id, world_comm)
  CALL mp_bcast (ephmat_dir, meta_ionode_id, world_comm)
  CALL mp_bcast (lscreen_tdbe, meta_ionode_id, world_comm)
  CALL mp_bcast (static_scr, meta_ionode_id, world_comm)
  CALL mp_bcast (mode_select, meta_ionode_id, world_comm)
  CALL mp_bcast (phself_anh, meta_ionode_id, world_comm)
  CALL mp_bcast (two_ef, meta_ionode_id, world_comm)
  CALL mp_bcast (phlw_chp, meta_ionode_id, world_comm)
  CALL mp_bcast (lorentz_gamma, meta_ionode_id, world_comm)
  CALL mp_bcast (phphself_r, meta_ionode_id, world_comm)
  ! --------------------------------------------------------------------------------
#endif
  !
  !-----------------------------------------------------------------------
