...
! SP : Not used for now but could be in the future. Would require the amn as well.
  ...
  INTEGER :: iuephiso           = 416
  INTEGER :: iuephg2w           = 417
  INTEGER :: iuselecqfd         = 418
  INTEGER :: iufelecrestart     = 419
  INTEGER :: iunphonrestart     = 420
  INTEGER :: iunphindx          = 421
  INTEGER :: iun3rdfc           = 422
  !
  PUBLIC :: iufilfelec ,iufilnphon, iukmeshf,iuqmeshf,iuephiso, iuephg2w,iuselecqfd,&
            iufelecrestart, iunphonrestart, iunphindx, iun3rdfc
  !
  PUBLIC :: io_error
  !
  CONTAINS
