  ...
  LOGICAL :: bte_restart,bte_phph, bte_elel
  LOGICAL :: ph_read,ph_rta
  !! 
  REAL(KIND=DP) :: facbroad,phwmin
  !! min. phonon frequency for ph-ph calculations
  REAL(KIND=DP) :: teph_max
  ...
  LOGICAL :: mode_select
  !! selectively screen EPC matrix elements
  LOGICAL :: phself_anh
  !! If true calculate the phonon frequency renormalization
  !! resulting from anharmonic effects, require 3rd force constants
  LOGICAL :: phphself_r
  !! If true calculate real part of phon-phon self energy
  LOGICAL :: two_ef
  !! two fermi energies
  LOGICAL :: lorentz_gamma
  !! Use electron linewidth to calculate delta function in the computation
  !! of the phonon linewidth
  LOGICAL :: phlw_chp
  !! Use the self-consistent expression for phonon linewidth derived by
  !! Prof. Cheol-Hwan Park
  !
  !-----------------------------------------------------------------------
