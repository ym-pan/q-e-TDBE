  ...
  REAL(KIND = DP), ALLOCATABLE ::&
    ...
    gamma_all(:, :, :, :),   &!  Gamma
    domega_all(:, :, :, :),  &!  nonadiabatic phonon self energy 
    ...
    sigma_ahc_ldw(:, :, :),          &!  AHC electron-phonon self-energy, low-energy Debye-Waller part.
  ...
  COMPLEX(KIND = DP), ALLOCATABLE :: &
    ...
    sigma_ahc_act(:, :, :)        !  AHC electron-phonon self-energy, active part.
  !--------------------------------------------------------------------------
  !--------------------------------------------------------------------------
  END MODULE elph2
  !--------------------------------------------------------------------------
