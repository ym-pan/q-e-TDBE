  ...
  CONTAINS
    ...
    USE constants_epw, ONLY : kelvin2eV, ryd2mev, ryd2ev, one, two, zero, eps4,   &
                              eps6, eps8, kelvin2Ry
    USE constants,  ONLY : pi
    USE epwcom,     ONLY : two_ef, ef_c, ef_v, lorentz_gamma, phlw_chp, temp_el
    !
    IMPLICIT NONE
    !
    INTEGER, INTENT(in) :: iqq
    ...
    REAL(KIND = DP) :: dw(nmodes)
    !! dw is the real part of the phonon self-energy
    ...
    REAL(KIND = DP) :: dw_tmp(nmodes)
    !! Temporary value of dw for av.
    ...
    DO itemp = 1, nstemp
      ...
      DO ismear = 1, nsmear
              ...
              DO ibnd = 1, nbndfst
                ...
                DO jbnd = 1, nbndfst
                  ...
                  ELSE
                    ...
                    ENDIF ! two_ef
                    !
                    wgkq0 = wgauss(-ekq2 * inv_eptemp, -99)
                    !
                    IF (lorentz_gamma) THEN 
                  ...
                  !
                  dw(imode) = dw(imode) + (weightr - weightr0) * g2 
                  !
                ENDDO ! jbnd
                !! Add extra intraband contribution
                !!! Intraband contribution to phonon linewidth
        ...
        CALL mp_sum(fermicount, inter_pool_comm)
        CALL mp_sum(dw, inter_pool_comm)
        CALL mp_barrier(inter_pool_comm)
        !
