  ...
  CONTAINS
    ...
    REAL(KIND = DP) :: inv_electemp, inv_phtemp
    !
                ...
                DO jbnd = 1, nbndfst
                  ...
                  IF (two_ef) THEN
                    ...
                    IF (etf(ibndmin - 1 + jbnd, ikq) > ef0) THEN
                      wgkq = wgauss(-(ekq + ef0 - (ef_c / ryd2ev) ) * inv_electemp, -99)
                    ELSE 
                      wgkq = wgauss(-(ekq + ef0 - (ef_v / ryd2ev) ) * inv_electemp, -99)
                    ENDIF
                  ELSE
